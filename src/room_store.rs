...
/// Current Unix time in milliseconds. Mirrors `app::session::now_ms` and
...
mod tests {
    ...
    async fn round_trips_through_disk() {
        let dir = std::env::temp_dir().join(format!("p2p-room-{}", uuid::Uuid::new_v4()));
