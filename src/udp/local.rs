...
use super::{
    UdpConn, UdpManager, CLEANUP_INTERVAL, MAX_UDP_SIZE, RETRY_INTERVAL, TUNNEL_READY_TIMEOUT,
    UDP_TIMEOUT,
};

impl UdpManager {
    pub(super) async fn read_local_packets(self: Arc<Self>, socket: Arc<UdpSocket>) {
    ...
    pub(super) async fn cleanup_loop(&self) {
