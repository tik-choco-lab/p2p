...
/// [`SEND_RETRY_BUDGET`].
pub(super) const SEND_RETRY_INITIAL_BACKOFF: Duration = Duration::from_millis(250);
...
pub(super) const SEND_RETRY_BUDGET: Duration = Duration::from_secs(8);
...
pub(super) async fn retry_with_backoff<F, Fut>(
    mut attempt: F,
