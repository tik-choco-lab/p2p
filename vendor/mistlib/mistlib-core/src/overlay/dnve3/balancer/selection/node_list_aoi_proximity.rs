...
use crate::overlay::dnve3::balancer::{DNVE3ConnectionBalancer, AOI_GUARD_CONNECTIONS};
use crate::overlay::dnve3::spatial_density::Vector3;
use crate::types::NodeId;
use std::collections::HashSet;

impl DNVE3ConnectionBalancer {
    pub(in crate::overlay::dnve3::balancer) fn select_node_list_aoi_proximity_nodes(
        &self,
        config: &Config,
        self_pos: Vector3,
